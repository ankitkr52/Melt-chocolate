    ...
    <section ref={footerRef} className='inner-container bg-orange text-white mt-20'>
      <div className='pt-24 grid grid-cols-12'>
        ...
        <div className='col-span-2'>
          ...
          <ul className='flex flex-col gap-3'>
            <li><a href="" className='hover:underline transition-all'>Flavors</a></li>
            <li><a href="" className='hover:underline transition-all'>Our Story</a></li>
            <li><a href="" className='hover:underline transition-all'>How it's Made</a></li>
            <li><a href="" className='hover:underline transition-all'>Gifting</a></li>
          </ul>
        </div>
        <div className='col-span-2'>
          <h3 className='text-xl font-bold mb-4'>Experience</h3>
          <ul className='flex flex-col gap-3'>
            <li><a href="" className='hover:underline transition-all'>Taste Journey</a></li>
            <li><a href="" className='hover:underline transition-all'>Texture & Melt</a></li>
            <li><a href="" className='hover:underline transition-all'>Ingredients</a></li>
            <li><a href="" className='hover:underline transition-all'>Process</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className='flex justify-between items-end mt-40'>
        <div className='flex gap-3'>
          {/* Facebook */}
          <a href='' className='bg-white w-9 h-9 rounded-full flex justify-center items-center hover:scale-110 transition-transform'>
        ...
        <a href='' className='flex items-center gap-2 underline hover:opacity-80 transition-opacity'>
      ...
      <div className='text-sm flex justify-between items-center py-6 border-t border-[#ffffff50] mt-12'>
        ...
        <div className='text-center'>
          Design by <span className='underline'>Ankit Sharma</span> &middot; &copy; 2025
        </div>

        <div className='opacity-50 text-xs'>All rights reserved</div>
      </div>
    </section>
  )
}
